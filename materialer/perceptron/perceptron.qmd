...
description-meta: "Forløberen til kunstige neurale netværk er perceptroner, som du kan læse mere om her i denne note."
date: ''
format:
    html: 
      self-contained: true
...
bibliography: perceptron-referencer.bib
nocite: | 
  @*
editor_options: 
...
Forløberen til kunstige neurale netværk er perceptroner, som du kan læse mere om her i denne note.
...
## Eksempel: Hvem skal jeg stemme på ved næste valg? {#sec-kandidattest}
...
# Perceptron Learning Algoritmen {#sec-perceptron_learning_algortimen}
...
Lad os så se på hvad Rosenblatts \"Perceptron Learning Algoritmen\" går
...
# Det kan gøres smartere med ADALINE {#sec-ADALINE}
...
#| warning: false
#| fig-cap-location: margin
#| fig-cap: Træningsdata hvor et af datapunkterne ved en fejl har fået en forkert targetværdi.
#| label: fig-punkter_graf4_5-1
library(aai)
...
#| warning: false
#| fig-cap-location: margin
#| fig-cap: Træningsdata hvor stort set alle datapunkterne er klassificeret korrekt.
#| label: fig-punkter_graf4_5-2
...
## Gradientnedstigning {#sec-ADALINE_gradientnedstigning}
...
\end{aligned}
$$
hvor vi startede med værdierne $w_0=0.5, w_1=0.5$, $w_2=0.5$ og 
$\eta=0.05$. Perceptronen kan trænes ved hjælp af [denne app](https://apps01.math.aau.dk/adaline/) (sæt stop-kriteriet til $0$, maksimalt antal iterationer til $200$ og vælg *identitet* som aktiveringsfunktion). 
...
til at anbefale vælgeren at stemme på rød blok.
:::
...
# Det kan gøres *endnu* smartere med simple neurale netværk!

I det foregående har vi set på, hvordan ADALINE algoritmen forsøger at minimere tabsfunktionen 
...
Det virker som en besnærende god idé! Men faktisk er denne tabsfunktion ikke altid super smart. Dét problem -- og en løsning på det -- kan du læse meget mere om i noten om [simple neurale netværk](../simple_neurale_net/simple_neurale_net.qmd).
