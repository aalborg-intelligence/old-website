...
image: ""
description-meta: "I opbygningen af kunstige neurale netværk er aktiveringsfunktioner helt centrale."
from: markdown+emoji
format:
    html:
      self-contained: true 
...
Når en [perceptron](../perceptron/perceptron.qmd), et [neuralt netværk](../simple_neurale_net/simple_neurale_net.qmd) eller et helt generelt [neuralt netværk](../neurale_net/neurale_net.qmd) trænes, så sker det som regel ved, at man forsøger at minimere en tabsfunktion $E$.
