...
På @fig-graf_snitkurve_partialx ses grafen for funktionen $f$ sammen med grafen for snitfunktionen $g(x)=f(x,y_0)$, hvor $y_0=-2$. Derudover er tangenten til grafen for $g$ i punktet $P(x_0, y_0, f(x_0,y_0))=P(1,-2,-7)$ indtegnet (stiplet linje). 
...
På helt tilsvarende vis vil grafen for snitfunktionen $h(y)=f(x_0,y)$ have en tangent i punktet $P(x_0, y_0, f(x_0,y_0))$ med hældning $f_y'(x_0,y_0)$. Dette er illustreret med eksemplet fra før i @fig-graf_snitkurve_partialy. 
...
\end{aligned}
$$
Denne tangentplan ses tegnet sammen med grafen for $f$ i @fig-graf_med_tangentplan.
