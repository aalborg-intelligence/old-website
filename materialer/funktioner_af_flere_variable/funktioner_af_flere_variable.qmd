...
\end{aligned}
$$
Den tilhørende snitkurve svarer til skæringskurven mellem grafen for $f$ og planen med ligning $y=-2$, som ses i @fig-graf_snitkurve_y. Bemærk, at snitfunktionen $g$ er et andengradspolynomium, hvis graf er en parabel med grene, som vender opad, idet koefficienten til andengradsleddet er positiv.
