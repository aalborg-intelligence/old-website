...
Her har vi brugt, at den afledede af en snitfunktion, hvor vi kun varierer $x$ er $f_{x}^{'}$, og den afledede af en snitfunktion, hvor vi kun varierer $y$ er $f_{y}^{'}$. Tallet $c_{1}$ ligger mellem $x_{0}$ og $x_{0} + h \cdot u_{1}$, og tallet $c_{2}$ ligger mellem $y_{0}$ og $y_{0} + h \cdot u_{2}$. Dette er vist i @fig-punkt_indskudt3.
