...
### Datasættet
Datasættet fra @fig-ret_linje ses i tabellen herunder, hvis du selv vil prøve at lave lineær regression på data. Data kan også hentes som en [Excel-fil her](krydsvalidering_files/data/data.xlsx).
```{r}
#| echo: false  
...
write_xlsx(dataTable,"krydsvalidering_files/data/data.xlsx")
...
tilnærme data. Med $n$ datapunkter (som alle have forskellige $x$-værdier), kan man faktisk altid finde et
