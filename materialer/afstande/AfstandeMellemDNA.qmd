...
(adenin). DNA har ikke U, men i stedet T (thymin) og DNA er dobbelt. U,
G, C, A og T er nukleotider.
...
herunder mennesket, der nedstammer fra hvilke - fylogenetiske træer.\
[ http://www.biotekunderviser.dk/sites/default/files/Handout Bioinformatik workshop Vejle 2.pdf]( http://www.biotekunderviser.dk/sites/default/files/Handout Bioinformatik workshop Vejle 2.pdf)
...
og T, mellem G og T, mellem G og C, kaldes *transversioner*.
Transitioner er hyppigere mutationer end transversioner, så afstanden
mellem $GATTACA$ og $GATTACG$ er mindre end mellem $GATTACA$ og
...
længere afstand. I KILDEN OVENFOR bruges følgende omkostninger og altså
afstande mellem DNA-strenge; det er et valg - der er mange andre
muligheder:
...
Vi vil finde afstanden fra $AGT$ til $ATG$. Der er mange muligheder for,
hvordan man kan komme fra $AGT$ til $ATG$, altså hvordan mutationerne
kunne have set ud. $$AGT \to ATGT \to ATG$$ Indsæt $T$ mellem $A$ og $G$
og fjern så det sidste $T$. Det koster $9+4 =13$ - længden af den vej er
$13$. En anden mulighed er $$AGT\to ATT \to ATG$$ Der er to
punktmutationer og begge er transversioner (fra $T$ til $G$ eller
omvendt), så det koster $2+2=4$. Det er faktisk den korteste vej, så
afstanden er $4$. At den faktisk er kortest, kræver mere eftertanke.
...
først at \"aligne\" - anbringe strengene, så de passer sammen på flest
mulige pladser. Og derefter udregne afstande, men det er stadig ikke
nemt - der skal algoritmer til:

Streng 1: $TCGTAGG$ Streng 2: $TCTGTATCGA$\
Første alignment:
$$\begin{matrix}T&C&G&-&-&-&T&A&G&G\\T&C&T&G&T&A&T&C&G&A\end{matrix}$$
Det koster indsættelse af $GTA$, $5+4\cdot 3=17$, to transversioner
$G\leftrightarrow T$ og $A\leftrightarrow C$ en transition
$G\leftrightarrow A$. I alt $17+4+1=22$.\
...
gange. I kan nok finde på eksempler, hvor det svarer sig at klippe flere
steder.
