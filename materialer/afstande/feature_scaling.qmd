...
Et første bud kunne være at bestemme den [euklidske afstand](AfstandeMellemPunkteriPlanen.qmd#sec-euklidisk_afstand) mellem de to punkter -- det der bare svarer til at bruge Pythagoras. Gør vi det får vi følgende afstandsmål mellem punkterne $(v_1,h_1)$ og $(v_2,h_2)$:
