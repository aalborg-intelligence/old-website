...
:::{#exm-euklid}
## Euklidsk afstand som metrik

Lad $M$ være alle punkter i planen og lad metrikken være den [euklidske afstand](AfstandeMellemPunkteriPlanen.qmd), som vi kender. Funktionen $d$ vil så tage to punkter $P(x_1,y_1)$ og $Q(x_2,y_2)$ i planen og give et reelt tal som output svarende til den euklidiske afstand mellem $P$ og $Q$. Det vil sige, at
...
:::{#exm-euklid}
## Euklidsk afstand som metrik, fortsat
...
En elev er træt af kvadratrødder og tænker, at man vel kan droppe den euklidske afstand og i stedet definere en afstand mellem to punkter $p(x_1,y_1)$  og $q(x_2,y_2)$ i planen som følger:
