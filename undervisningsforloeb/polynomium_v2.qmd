...
1. Finde et andengradspolynomium som ikke har nogle rødder (husk at $a=1$). Notér din værdi af $b$ og $c$ og sæt her targetværdien $t$ til $t=-1$.
2. Finde et andengradspolynomium som har én eller to rødder (husk at $a=1$). Notér din værdi af $b$ og $c$ og sæt her targetværdien $t$ til $t=1$.
