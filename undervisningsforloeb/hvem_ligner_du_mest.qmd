...
punkter -- samt et enkelt gråt punkt $P$ i midten. Vurdér ud fra de øvrige punkter i nærheden af $P$, om du synes, at $P$ bør være rødt, blåt eller grønt så det mest ligner sine naboer. Ét af de blå punkter er særligt markeret, men da det ligger ret langt fra $P$ bør det nok ikke betyde så meget for, hvilket farve $P$ skal have, som de punkter, der ligger tættere på $P$.
...
I stedet for at sammenligne på DNA niveau, sammenlignes også nogle gange på aminosyre niveau, hvor flere bogstaver anvendes. Den præcise betydning af disse bogstaver er ikke vigtig her.
