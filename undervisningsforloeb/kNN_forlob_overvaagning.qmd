...
Her til sidst skal vi lege lidt med et program, som hedder [Orange](https://orangedatamining.com/). For at gøre det får vi brug for de [træningsdata](kNN_forlob_overvaagning_filer/data/Træningsdata.xlsx) og [testdata](kNN_forlob_overvaagning_filer/data/Testdata.xlsx), som vi har brugt i det foregående.
